...
export const cfg = {
  ...
  // tenancy / defaults
  // NOTE:
  // DEFAULT_TENANT_KEY is runtime fallback only.
  // It must NOT be a hardcoded client like "neox".
  // --------------------------------------------------
  ...
  // --------------------------------------------------
  // LLM providers
  // global credentials live here
  // per-tenant provider choice will live in DB config
  // --------------------------------------------------
  ...
  // meta gateway
  // IMPORTANT:
  // tenant-specific page / ig ids do NOT belong here.
  // those live in DB / tenant config / tenant secrets.
  // --------------------------------------------------
